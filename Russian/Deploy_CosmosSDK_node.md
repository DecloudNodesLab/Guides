...
* При использовании BINARY_LINK необзодимо дополнительно добавить переменную BINARY - содержащую имя бинарного файла. 
Если ее не установить - имя бинарного файла будет задано как "serviced".

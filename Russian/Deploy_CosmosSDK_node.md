...
- "PRUNING=off" - отключение пруннинга. Если оставить переменную пустой - пруннинг будет включен, 
                  можно добавить значения  KEEP_RECENT и INTERVAL при необходимости.
